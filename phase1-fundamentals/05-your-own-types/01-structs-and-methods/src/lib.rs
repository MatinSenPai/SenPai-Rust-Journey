//! Exercises for 1.5.1 — Structs and methods.
//!
...
impl Series {
    ...
    pub fn new(title: String, episodes: u32) -> Self {
        todo!("build a Series from the two arguments, with the other two fields at their starting values")
    }
    ...
    pub fn remaining(&self) -> u32 {
        todo!("how many episodes are still unwatched, and never a negative answer")
    }
    ...
    pub fn watch_one(&mut self) -> bool {
        todo!("advance the count when there is something left, and report whether you did")
    }
    ...
    pub fn mark_favourite(&mut self) {
        todo!("make this series a favourite")
    }
    ...
    pub fn summary(&self) -> String {
        todo!("the one-line description above, with the marker only when it applies")
    }
    ...
    pub fn into_title(self) -> String {
        todo!("hand back the title, consuming the series")
    }
}
