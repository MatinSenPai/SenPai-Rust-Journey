//! Exercises for 1.1.4 — Functions and expressions.
//!
...
pub fn hypotenuse(a: f64, b: f64) -> f64 {
    todo!("square both sides, add them, and take the root of the result")
}
...
pub fn box_count(items: u32, per_box: u32) -> u32 {
    todo!("divide, but round upwards instead of down")
}
...
pub fn is_leap_year(year: u32) -> bool {
    todo!("combine the three rules into a single boolean expression")
}
...
pub fn total_price(unit_price_rial: u64, quantity: u64, discount_percent: u64) -> u64 {
    todo!("work out the subtotal, then the discount, then what is left")
}
...
pub fn diagonal_inches(width_px: f64, height_px: f64, dpi: f64) -> f64 {
    todo!("get the diagonal in pixels from the function above, then convert")
}
