...
//!
//! ```sh
//! cargo test -p p3-08-03-integration-tests-with-testcontainers -- --ignored
//! ```
...
use p3_08_03_integration_tests_with_testcontainers_solution::{run_schema, WidgetRepository};
