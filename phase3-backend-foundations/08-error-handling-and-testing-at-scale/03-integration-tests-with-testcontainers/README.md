...
`cargo test -p p3-08-03-integration-tests-with-testcontainers` (passes
trivially — every Docker-dependent test is `#[ignore]`d). If you have
Docker running locally: `cargo test -p p3-08-03-integration-tests-with-testcontainers -- --ignored`.
