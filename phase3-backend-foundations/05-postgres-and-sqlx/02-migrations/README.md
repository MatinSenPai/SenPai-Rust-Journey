...
## Why every test carries `#[serial(p3_05_02_migrations_db)]`
...
tests touched the same live database at the same instant. `#[serial(p3_05_02_migrations_db)]`
...
```sh
sudo -u postgres psql -c "CREATE DATABASE p3_05_02_migrations OWNER taskforge;"
```
...
```sh
DATABASE_URL=postgres://taskforge:taskforge@localhost:5432/p3_05_02_migrations \
  cargo test -p p3-05-02-migrations -- --ignored
```
