...
This lesson's database (`p3_05_02_migrations`) is **not** wiped between
...
its own dedicated `p3_05_02_migrations` database instead.

## Why every test needs `#[serial(p3_05_02_migrations_db)]`
...
`before` and `after` counts. `#[serial(p3_05_02_migrations_db)]` forces
